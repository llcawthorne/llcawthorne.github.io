...
Service level.  He had to make a "transactionManager" Bean and use an 
...
the repository and you're good to go.  Each test is transactional, so they
...
query if the autogenerated language can't handle what you're after.  He defined
...
a watch if you're looking for something to view with your Safari Books Online
membership.
